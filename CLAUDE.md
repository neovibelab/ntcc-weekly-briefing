...
매주 금요일 저녁 8시 작성 및 발행. HTML 단일 파일로 제작하여 Vercel(GitHub Pages)에 배포.
...
├── NEWSPAPER_MMDD.html                # 정규호 (매주 금요일 저녁 8시 작성·발행)
...
- [ ] 환율이 푸터에 표기?
- [ ] 지역별 기사 배분 균형?
- [ ] 마스트헤드 날짜 형식: `2026년 M월 D일 금요일 (M.D–D)` (발행일 = 금요일 저녁 8시 기준)
